...
curl -v -H 'Content-Type: application/json' -H 'apikey:super-secret-123' -X POST http://api.kong.example.com/api/v1/article -d '{"username":"gonzalo","text":"Daily note: to something else, butterfly", "wait_time": "0"}' | jq .
